  ...
  events: [
    {
      ...
      title: { ko: "사용량 소진 보상", en: "Usage depletion compensation" },
      text: "A broad usage-limit compensation reset was recorded after service depletion.",
      scope: { ko: "유료 Codex 사용자", en: "Paid Codex users" }, author: "OpenAI Status",
    ...
    },
    {
      ...
      title: { ko: "출시 리셋 구간", en: "Launch reset window" },
      text: "A launch-period reset applied to paid Codex users.",
      scope: { ko: "유료 Codex 사용자", en: "Paid Codex users" }, author: "Codex Radar",
    ...
    },
    {
      ...
      title: { ko: "글로벌 Codex 쿼터 리셋", en: "Global Codex quota reset" },
      text: "We have reset usage limits across Codex and ChatGPT Work.",
      scope: { ko: "Codex 및 ChatGPT Work 공용 한도", en: "Shared Codex and ChatGPT Work limits" }, author: "OpenAI",
    ...
    },
    {
      ...
      title: { ko: "활성 사용자 기념 리셋", en: "Active-user milestone reset" },
    ...
    },
    {
      ...
      title: { ko: "주간 한도 하드 리셋", en: "Weekly limit hard reset" },
      text: "A Codex and ChatGPT Work reset returned weekly usage to 100%.",
      scope: { ko: "Codex 및 ChatGPT Work 사용자", en: "Codex and ChatGPT Work users" }, author: "Tibo",
    ...
    },
    {
      ...
      title: { ko: "글로벌 주말 리셋", en: "Global weekend reset" },
    ...
    },
    {
      ...
      title: { ko: "마일스톤 사용량 리셋", en: "Milestone usage reset" },
    ...
    },
    {
      ...
      scope: { ko: "모든 Codex 및 ChatGPT Work 사용자", en: "All Codex and ChatGPT Work users" }, author: "Tibo",
    ...
    },
    {
      ...
      title: { ko: "효율 개선 리셋", en: "Efficiency update reset" },
      text: "I've reset usage limits for all ChatGPT Work and Codex users.",
      scope: { ko: "모든 ChatGPT Work 및 Codex 사용자", en: "All ChatGPT Work and Codex users" }, author: "Tibo",
    ...
    },
    {
      ...
      scope: { ko: "Codex 및 ChatGPT Work 공용 한도", en: "Shared Codex and ChatGPT Work limits" }, author: "Tibo",
